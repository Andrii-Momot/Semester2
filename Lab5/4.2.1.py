...
class Quadrate(Figure):
    ...
    def _draw(self, color):
        ...
        down()
        setpos(self._x+self._a, self._y)
        setpos(self._x + self._a, self._y+ self._a)
        setpos(self._x, self._y + self._a)
        setpos(self._x, self._y)
        up()
#################### клас Triangle  ############################
################################################################
...
class Trapezoid(Figure):
    ...
    def _draw(self, color):
        ...
        down()
        setpos(self._x + self._a, self._y)
        setpos(self._x + (self._a+self._b)/2, self._y + self._h)
        setpos(self._x + (self._a-self._b)/2, self._y + self._h)
        setpos(self._x, self._y)
        up()
...
if __name__ == '__main__':
    ...
    ###### Перевірка трапеції ############
    t = Trapezoid(120, 120, 150, 130, 50,"red")
    t.show()
    t.move(-30, -140)
    t.hide()
